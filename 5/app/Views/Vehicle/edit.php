...
<head>
    ...
    <title>Sửa phương tiện - Quản lý Bảo hiểm Xe</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .read-only { background-color: #f5f5f5; color: #666; }
    </style>
</head>
<body>
<div class="container">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo $baseUrl; ?>/public/index.php?c=Vehicle&m=edit&id=<?php echo $vehicle['MaXe']; ?>">
            <div class="form-group">
                <label for="MaXe">Mã xe:</label>
                <input type="text" id="MaXe" name="MaXe" value="<?php echo htmlspecialchars($vehicle['MaXe']); ?>" class="read-only" readonly>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="SoKhung" name="SoKhung" value="<?php echo htmlspecialchars($data['SoKhung'] ?? ''); ?>" class="read-only" readonly>
            </div>
            
            <div class="form-group">
                <label for="SoMay">Số máy:</label>
                <input type="text" id="SoMay" name="SoMay" value="<?php echo htmlspecialchars($data['SoMay'] ?? ''); ?>" class="read-only" readonly>
            </div>
            
            <div class="button-group">
                <button type="submit" class="btn">Lưu</button>
                <a href="<?php echo $baseUrl; ?>/public/index.php?c=Vehicle&m=view&id=<?php echo $vehicle['MaXe']; ?>" class="btn btn-secondary">Hủy</a>
            </div>
        </form>
    </div>
</div>
