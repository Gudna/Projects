...
<head>
    ...
    <title>Sửa khách hàng - Quản lý Bảo hiểm Xe</title>
    <style>
...
<div class="container">
    ...
    <div class="card">
        ...
        <form method="POST" action="<?php echo $baseUrl; ?>/public/index.php?c=Customer&m=edit&id=<?php echo $customer['MaKH']; ?>">
            <div class="form-group">
                <label for="MaKH">Mã khách hàng:</label>
                <input type="text" id="MaKH" name="MaKH" value="<?php echo htmlspecialchars($customer['MaKH']); ?>" class="read-only" readonly>
            </div>
            ...
            <div class="button-group">
                ...
                <a href="<?php echo $baseUrl; ?>/public/index.php?c=Customer&m=view&id=<?php echo $customer['MaKH']; ?>" class="btn btn-secondary">Hủy</a>
            </div>
        </form>
    </div>
</div>
